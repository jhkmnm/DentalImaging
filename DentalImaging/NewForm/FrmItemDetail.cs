    ...
    public partial class FrmItemDetail : XtraForm
    {
        ...
        public void InitData()
        {
            ...
            if (User.CurrentPatient != null)
            {
                ...
                var add = GetText("新建");
                NOs.Insert(0, new CListItem(add));
                BindComboBoxItems(txtUsagePos, NOs, add);
        ...
        {
            int index = -1;
            if (txtUsagePos.Text == GetText("新建"))
            {
        ...
        private void FrmItemDetail_Shown(object sender, EventArgs e)
        {
