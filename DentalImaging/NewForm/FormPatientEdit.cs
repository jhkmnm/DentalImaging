...
namespace DentalImaging.NewForm
{
    public partial class FormPatientEdit : XtraForm
    {
        ...
        public void BandData()
        {
            ...
            if (dataSource != null)
            {
                foreach (var info in dataSource.OrderBy(o => o.Number))
                {
                    ...
                    dr[GetText("联系方式")] = info.Tel1;
                    dr[GetText("地址")] = info.Address1;
                    dt.Rows.Add(dr);
                }
            }
        ...
        private DataTable CreateTable(string columns)
        {
            ...
            {
                dt.Columns.Add(new DataColumn(GetText(col), typeof(string)));
            }
            return dt;
        }
        ...
        private void FormPatientEdit_Shown(object sender, EventArgs e)
        {
            LanguageHelp.InitControlLanguage(this);
            删除ToolStripMenuItem.Text = GetText(删除ToolStripMenuItem.Tag.ToString());
        }
